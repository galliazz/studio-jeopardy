...
import { localeInfo, useLocale } from "@/i18n";
import { cn } from "@/lib/utils";

/*
 * Radix non legge `dir` da <html>: senza dirglielo, in arabo il sottomenu si
 * aprirebbe a destra e le frecce della tastiera andrebbero al contrario.
 */
const DropdownMenu = ({
  dir,
  ...props
  ...
  return <DropdownMenuPrimitive.Root dir={dir ?? localeInfo(locale).dir} {...props} />;
};
